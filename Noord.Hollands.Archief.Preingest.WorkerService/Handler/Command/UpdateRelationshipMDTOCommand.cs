...
namespace Noord.Hollands.Archief.Preingest.WorkerService.Handler.Command
{
    ...
    public class UpdateRelationshipMDTOCommand : AbstractPreingestCommand
    {
        ...
        public UpdateRelationshipMDTOCommand(ILogger<PreingestEventHubHandler> logger, Uri webapi) : base(logger, webapi) { }
        ...
        public override void Execute(HttpClient client, Guid currentFolderSessionId, Settings settings)
        {
            TryExecuteOrCatch(client, currentFolderSessionId, (id) =>
            {
                ...
                api.UpdateRelationshipReferencesForMDTOAsync(id).GetAwaiter().GetResult();
            });
        }
    }
}
