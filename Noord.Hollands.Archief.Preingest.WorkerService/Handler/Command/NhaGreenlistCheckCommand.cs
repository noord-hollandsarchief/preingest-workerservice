...
{
    /// <summary>
    /// Concrete class command for calling the client to do a compare with all binary files vs. NHA preference list.
    /// </summary>
    ...
    {
        public override ValidationActionType ActionTypeName => ValidationActionType.GreenListHandler;
        /// <summary>
        /// Initializes a new instance of the <see cref="NhaGreenlistCheckCommand"/> class.
        /// </summary>
        ...
        public override void Execute(HttpClient client, Guid currentFolderSessionId, Settings settings)
        {
            TryExecuteOrCatch(client, currentFolderSessionId, (id) =>
            {
                ...
                api.PreferenceGreenListComparisonCheckAsync(id).GetAwaiter().GetResult();
            });
        }
    }
}
