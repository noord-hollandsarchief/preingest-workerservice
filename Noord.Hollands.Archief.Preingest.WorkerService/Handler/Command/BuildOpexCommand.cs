...
namespace Noord.Hollands.Archief.Preingest.WorkerService.Handler.Command
{
    ...
    public class BuildOpexCommand : AbstractPreingestCommand
    {
        public override ValidationActionType ActionTypeName => ValidationActionType.BuildOpexHandler;
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildOpexCommand"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        /// <param name="webapi">The webapi.</param>
        public BuildOpexCommand(ILogger<PreingestEventHubHandler> logger, Uri webapi) : base(logger, webapi) { }
