...
namespace Noord.Hollands.Archief.Preingest.WorkerService.Handler.Command
{
    ...
    public class BuildNonMetadataOpexCommand : AbstractPreingestCommand
    {
        ...
        public BuildNonMetadataOpexCommand(ILogger<PreingestEventHubHandler> logger, Uri webapi) : base(logger, webapi) { }
