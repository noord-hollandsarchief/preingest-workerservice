...
namespace Noord.Hollands.Archief.Preingest.WorkerService.OpenAPI
{
    ...
    /// </summary>
    public partial class SignatureClient : Noord.Hollands.Archief.Preingest.WorkerService.OpenAPI.swaggerClient
    {
        public SignatureClient(string baseUrl, System.Net.Http.HttpClient httpClient) : base(baseUrl, httpClient)
        {
        }
